/*! \file lcd.c
 *
 *  This file provides functions for controlling an LCD display.
 *
 */
...
void lcd_writeChar(char character)
{
    ...
    switch (character)
    {
        ...
        case (char)0x9F:
            ...
            break;
        case (char)0x84:	// Character code for 'Ä'
            character = 0xE1;
            break;
        case (char)0x96:	// Character code for 'Ö'
            character = 0xEF;
            break;
        case (char)0x9C:	// Character code for 'Ü'
            character = 0xF5;
            break;
        case (char)0xB0:
        ...
        case (char)0xB5 :
            ...
            break;
    	case (char)0xC2 :
    		os_leaveCriticalSection(); // Ignore the Unicode prefix
    		return;
    	case (char)0xC3 :
    		os_leaveCriticalSection(); // Ignore the Unicode prefix
    		return;
