...
#define DEFAULT_PRIORITY			OS_PRIO_NORMAL
...
//! The sum of all memory areas should be smaller or equal than what we have available
#if (STACK_SIZE_PROC * MAX_NUMBER_OF_PROCESSES + STACK_SIZE_MAIN + STACK_SIZE_ISR + AVR_MEMORY_SRAM / 2) > AVR_MEMORY_SRAM
